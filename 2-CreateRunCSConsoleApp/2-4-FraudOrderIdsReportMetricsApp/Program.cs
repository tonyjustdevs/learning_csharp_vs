...
int NumberOfBaldFrauds      = FraudulentOrderIds.Length;
...
System.Console.WriteLine($"The Total Number of Bald Frauds: {NumberOfBaldFrauds} (v1)");
System.Console.WriteLine($"The Total Number of Bald Frauds: {FraudulentOrderIds.Length} (v2)");
